...
A **Learning Management System** built with React.  
Features: role-based access, course structure, quizzes, and progress tracking.
...
A **C++ ecosystem simulation** with OOP design.  
Models interactions between organisms in a dynamic environment.
